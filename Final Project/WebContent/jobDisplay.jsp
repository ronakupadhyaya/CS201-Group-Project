...
<head>
    ...
    <script>
      function addToCalendar() {
          ...
          var cname = job.getCompanyName();
          var title = job.getTitle();
          var deadline = job.getDeadline();
          xhttp.open("GET", "Calendar?cname=" + cname + "&title=" + title + "&deadline=" + deadline, false);
          xhttp.send();
    	  return false;
      }
    </script>
...
<body>
	...
	<div id="buttons">
		<button id="save" onclick="addToCalendar();"></button>
